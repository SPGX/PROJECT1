    ...
    <table width = '300px' align = 'center'>
        <tr>
            <td>
                ...
                <input class = 'form-control' name = 'email' id = 'p1' type = 'email' required placeholder = 'อีเมลล์ : '/>
...
if (isset($_POST['button1'])){
    ...
    try {
        if ($result -> execute() && $pass == $repass){
            ...
            echo "<table width = '300px' align = 'center'><tr><td><p class = 'alert alert-danger' align = 'center'>ชื่อผู้ใช้งาน หรือ Email ซ้ำกับฐานข้อมูล</p></td></tr></table>";
        }
    } catch (\Throwable $th) {
        $error = $th -> getMessage();
    }
